...
public class ProductEntity {
    ...
    // NEW: when you last updated (admin edits)
    private LocalDateTime lastUpdated;

    public ProductEntity() {}

    public ProductEntity(Long id, String name, String category, double price, String source) {
        this.id = id;
        this.name = name;
    ...
    // ---------- EXTRA camelCase getters (so your service/controller won't break) ----------
    // these fix errors like getMeeshoPrice() not found

    public Double getMeeshoPrice() { return meesho_price; }
    public void setMeeshoPrice(Double v) { this.meesho_price = v; }

    public Double getMyntraPrice() { return myntra_price; }
    public void setMyntraPrice(Double v) { this.myntra_price = v; }

    public Double getShopsyPrice() { return shopsy_price; }
    public void setShopsyPrice(Double v) { this.shopsy_price = v; }
}
